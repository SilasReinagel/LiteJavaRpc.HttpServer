...
import io.theo.http.server.HttpServer;
import io.theo.http.server.NanoHTTPD;
import io.theo.json.Json;
...
public final class JsonRpcWebApiServer
{
    ...
    public JsonRpcWebApiServer(final int port)
    {
    ...
    private NanoHTTPD.Response serve(NanoHTTPD.IHTTPSession session)
    {
        ...
        return createHttpResponse(NanoHTTPD.Response.Status.NOT_FOUND, "text/plain", "Not Found");
    }
